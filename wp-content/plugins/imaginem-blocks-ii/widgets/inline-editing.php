...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'imaginem-blocks' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Content', 'imaginem-blocks' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Title', 'imaginem-blocks' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Description', 'imaginem-blocks' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'imaginem-blocks' ),
			]
		);
